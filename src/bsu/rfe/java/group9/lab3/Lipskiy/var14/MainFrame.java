...
public class MainFrame extends JFrame {
	...
	private GornerTableModel data;
		...
		// Создать новое действие по меню помощи "О программе"
		Action aboutAction = new AbstractAction("О программе") {
			public void actionPerformed(ActionEvent event) {
				JOptionPane.showMessageDialog(null, "Автор:\nИлья Липский\n9-я группа", "О программе" + "о программе", JOptionPane.INFORMATION_MESSAGE);
			}
		};
